...
namespace ViopOrtalamaHesaplama.UI.Controllers
{
    public class LoginController : Controller
    {
       private readonly UserManager<AppUser> _userManager;
        ...
        private readonly IGenericRepository<Contract> _contractService;

        public LoginController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IWebHostEnvironment env, IGenericRepository<Contract> contractService)
        {
        ...
        //       return RedirectToAction("HomePage", "Contrat", user.Id);
        //}
        //    else
        //    {
